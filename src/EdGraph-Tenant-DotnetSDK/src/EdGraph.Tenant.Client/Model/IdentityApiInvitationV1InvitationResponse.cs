...
namespace EdGraph.Tenant.Client.Model
{
    ...
    public partial class IdentityApiInvitationV1InvitationResponse : IEquatable<IdentityApiInvitationV1InvitationResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as IdentityApiInvitationV1InvitationResponse);
        }

        /// <summary>
        /// Returns true if IdentityApiInvitationV1InvitationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityApiInvitationV1InvitationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityApiInvitationV1InvitationResponse input)
        {
            if (input == null)
            {
                return false;
