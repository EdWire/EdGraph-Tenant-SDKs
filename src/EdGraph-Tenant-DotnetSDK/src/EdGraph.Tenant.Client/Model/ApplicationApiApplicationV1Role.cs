...
namespace EdGraph.Tenant.Client.Model
{
    ...
    public partial class ApplicationApiApplicationV1Role : IEquatable<ApplicationApiApplicationV1Role>, IValidatableObject
    {
        /// <summary>
        ...
        public ApplicationApiApplicationV1Role(string roleName = default(string), bool isDefault = default(bool), bool isAvailableForTenants = default(bool))
        {
        ...
        {
            return this.Equals(input as ApplicationApiApplicationV1Role);
        }

        /// <summary>
        /// Returns true if ApplicationApiApplicationV1Role instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationApiApplicationV1Role to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationApiApplicationV1Role input)
        {
            if (input == null)
            {
                return false;
