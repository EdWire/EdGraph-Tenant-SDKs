...
{
    /// <summary>
    /// ApplicationApiApplicationV2ApplicationProfileResponse
    /// </summary>
    [DataContract(Name = "ApplicationApi.Application.V2.ApplicationProfileResponse")]
    public partial class ApplicationApiApplicationV2ApplicationProfileResponse : IEquatable<ApplicationApiApplicationV2ApplicationProfileResponse>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicationApiApplicationV2ApplicationProfileResponse {\n");
        ...
        {
            return this.Equals(input as ApplicationApiApplicationV2ApplicationProfileResponse);
        }

        /// <summary>
        /// Returns true if ApplicationApiApplicationV2ApplicationProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationApiApplicationV2ApplicationProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationApiApplicationV2ApplicationProfileResponse input)
        {
            if (input == null)
            {
                return false;
