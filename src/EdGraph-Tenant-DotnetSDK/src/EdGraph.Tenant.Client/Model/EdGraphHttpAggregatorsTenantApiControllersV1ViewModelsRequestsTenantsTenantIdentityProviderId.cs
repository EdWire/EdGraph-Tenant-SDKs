...
namespace EdGraph.Tenant.Client.Model
{
    ...
    /// </summary>
    /// <value>Contains the list of the supported login identity providers</value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsRequestsTenantsTenantIdentityProviderId
    {
        /// <summary>
