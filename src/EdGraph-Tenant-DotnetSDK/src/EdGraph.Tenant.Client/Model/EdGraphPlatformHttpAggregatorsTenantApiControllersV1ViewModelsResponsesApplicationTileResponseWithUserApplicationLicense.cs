...
namespace EdGraph.Tenant.Client.Model
{
    ...
    public partial class EdGraphPlatformHttpAggregatorsTenantApiControllersV1ViewModelsResponsesApplicationTileResponseWithUserApplicationLicense : IValidatableObject
    {
        /// <summary>
