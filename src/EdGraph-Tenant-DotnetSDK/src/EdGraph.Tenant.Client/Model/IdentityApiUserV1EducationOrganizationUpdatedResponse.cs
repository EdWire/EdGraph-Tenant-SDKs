...
namespace EdGraph.Tenant.Client.Model
{
    ...
    public partial class IdentityApiUserV1EducationOrganizationUpdatedResponse : IEquatable<IdentityApiUserV1EducationOrganizationUpdatedResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as IdentityApiUserV1EducationOrganizationUpdatedResponse);
        }

        /// <summary>
        /// Returns true if IdentityApiUserV1EducationOrganizationUpdatedResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityApiUserV1EducationOrganizationUpdatedResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityApiUserV1EducationOrganizationUpdatedResponse input)
        {
            if (input == null)
            {
                return false;
