...
namespace EdGraph.Tenant.Client.Model
{
    ...
    public partial class TenantApiTenantV1UpdateOrganizationRequest : IEquatable<TenantApiTenantV1UpdateOrganizationRequest>, IValidatableObject
    {
        ...
        public TenantApiTenantV1UpdateOrganizationRequest(string tenantId = default(string), string identifierValue = default(string), string discriminator = default(string), string source = default(string), string shortNameOfInstitution = default(string), string nameOfInstitution = default(string), bool includeInJwt = default(bool))
        {
