...
namespace EdGraph.Tenant.Client.Model
{
    ...
    public partial class TenantApiTenantV1OrganizationUpdatedResponse : IEquatable<TenantApiTenantV1OrganizationUpdatedResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TenantApiTenantV1OrganizationUpdatedResponse);
        }

        /// <summary>
        /// Returns true if TenantApiTenantV1OrganizationUpdatedResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantApiTenantV1OrganizationUpdatedResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantApiTenantV1OrganizationUpdatedResponse input)
        {
            if (input == null)
            {
                return false;
