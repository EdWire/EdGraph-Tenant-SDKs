...
{
    /// <summary>
    /// IdentityApiUserV1CreateLocalUserRequest
    /// </summary>
    [DataContract(Name = "IdentityApi.User.V1.CreateLocalUserRequest")]
    public partial class IdentityApiUserV1CreateLocalUserRequest : IEquatable<IdentityApiUserV1CreateLocalUserRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityApiUserV1CreateLocalUserRequest" /> class.
        /// </summary>
        ...
        public IdentityApiUserV1CreateLocalUserRequest(string tenantId = default(string), string userName = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), string role = default(string), string phoneNumber = default(string), bool lockoutEnabled = default(bool), string password = default(string), bool autoGeneratedPassword = default(bool), bool twoFactorEnabled = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityApiUserV1CreateLocalUserRequest {\n");
        ...
        {
            return this.Equals(input as IdentityApiUserV1CreateLocalUserRequest);
        }

        /// <summary>
        /// Returns true if IdentityApiUserV1CreateLocalUserRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityApiUserV1CreateLocalUserRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityApiUserV1CreateLocalUserRequest input)
        {
            if (input == null)
            {
                return false;
