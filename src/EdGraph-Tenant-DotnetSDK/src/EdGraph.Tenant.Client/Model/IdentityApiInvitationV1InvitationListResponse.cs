...
namespace EdGraph.Tenant.Client.Model
{
    ...
    public partial class IdentityApiInvitationV1InvitationListResponse : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityApiInvitationV1InvitationListResponse" /> class.
        /// </summary>
        ...
        public IdentityApiInvitationV1InvitationListResponse(string tenantId = default(string), string invitationId = default(string), string firstName = default(string), string lastName = default(string), string email = default(string), string role = default(string), string invitationToken = default(string), IdentityApiInvitationV1InvitationStatus? invitationStatus = default(IdentityApiInvitationV1InvitationStatus?), string invitationSentDateTime = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityApiInvitationV1InvitationListResponse {\n");
