...
namespace EdGraph.Tenant.Client.Model
{
    ...
    public partial class ApplicationApiApplicationV1ApplicationProfileResponse : IEquatable<ApplicationApiApplicationV1ApplicationProfileResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ApplicationApiApplicationV1ApplicationProfileResponse);
        }

        /// <summary>
        /// Returns true if ApplicationApiApplicationV1ApplicationProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationApiApplicationV1ApplicationProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationApiApplicationV1ApplicationProfileResponse input)
        {
            if (input == null)
            {
                return false;
