...
namespace EdGraph.Tenant.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TenantApi.Tenant.V1.CreateOrganizationRequest")]
    public partial class TenantApiTenantV1CreateOrganizationRequest : IEquatable<TenantApiTenantV1CreateOrganizationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantApiTenantV1CreateOrganizationRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantApiTenantV1CreateOrganizationRequest {\n");
        ...
        {
            return this.Equals(input as TenantApiTenantV1CreateOrganizationRequest);
        }

        /// <summary>
        /// Returns true if TenantApiTenantV1CreateOrganizationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantApiTenantV1CreateOrganizationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantApiTenantV1CreateOrganizationRequest input)
        {
            if (input == null)
            {
                return false;
