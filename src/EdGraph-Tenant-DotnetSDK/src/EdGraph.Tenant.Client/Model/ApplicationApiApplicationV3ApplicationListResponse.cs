...
{
    /// <summary>
    /// ApplicationApiApplicationV3ApplicationListResponse
    /// </summary>
    [DataContract(Name = "ApplicationApi.Application.V3.ApplicationListResponse")]
    public partial class ApplicationApiApplicationV3ApplicationListResponse : IEquatable<ApplicationApiApplicationV3ApplicationListResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationApiApplicationV3ApplicationListResponse" /> class.
        /// </summary>
        ...
        public ApplicationApiApplicationV3ApplicationListResponse(string tenantId = default(string), string applicationId = default(string), string applicationName = default(string), string version = default(string), string tags = default(string), string groups = default(string), ApplicationApiApplicationV3ApplicationStatus? applicationStatus = default(ApplicationApiApplicationV3ApplicationStatus?), string createdBy = default(string), string createdDateTime = default(string), string lastModifiedBy = default(string), string lastModifiedDateTime = default(string), ApplicationApiApplicationV3ApplicationSubscriptionType? subscriptionType = default(ApplicationApiApplicationV3ApplicationSubscriptionType?), string documentationUrl = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicationApiApplicationV3ApplicationListResponse {\n");
        ...
        {
            return this.Equals(input as ApplicationApiApplicationV3ApplicationListResponse);
        }

        /// <summary>
        /// Returns true if ApplicationApiApplicationV3ApplicationListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationApiApplicationV3ApplicationListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationApiApplicationV3ApplicationListResponse input)
        {
            if (input == null)
            {
                return false;
