...
namespace EdGraph.Tenant.Client.Model
{
    ...
    public partial class IdentityApiStaffClassificationV1StaffClassificationUpdatedResponse : IValidatableObject
    {
        ...
        public IdentityApiStaffClassificationV1StaffClassificationUpdatedResponse(string id = default(string))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityApiStaffClassificationV1StaffClassificationUpdatedResponse {\n");
